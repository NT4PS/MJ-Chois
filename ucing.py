...
if sandi == '2':
	print('Welcome Ucing Adix /n jangan lupa istirahat?')
else:
    ws.close()
xz = 1
status = 'tidur'
...
mypesan = '{"live_id":'+slink+',"token":"'+botauthtoken2+'","event":"live_join","appversion":"5.4.9","useragent":"Android"}'###### end 
...
def on_message(ws, message):
        ...
        evn = chat['event']
        kesurupan = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"[ＴＡＮＴＥ ＶＥＲＡ] bisa bikin puas harga pas😉😚😍 "}'
        if 1 == 1:
            if z == 0:
                ws.send(kesurupan)
                z = 1
        ...
        emot = ['🤭🤭🤭', '🙄🙄🙄', '😝😝😝', '😇😇😇', '😌😌😌', '😔😔😔', '🥺🥺🥺']
        ya = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"' + nick + ' Iya... TAPI BOONG😋 ' + random.choice(emot) + '"}'
        tidak = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"' + nick + ' Apasih Kamutuh Tanya Ae 🐽 ' + random.choice(emot) + '"}'
        bisajadi = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"' + nick + '  Emang Aku Peduli🙄 ' + random.choice(emot) + '"}'
        bodoamat = '{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":"' + nick + '  Dahlah Cape Kak ☺️ ' + random.choice(emot) + '"}'
        listjawaban = [
        ...
        lsjoin = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":" ' + nick + random.choice(hantu) + '😕' + '"}'
        ...
        ljoin = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":" ' + nick + random.choice(sapa) + ' '+ '"}'
        ...
        llike = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":" ' + nick + random.choice(likee) + '❤️' + '"}'
        tidur = '{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":" ' + nick + ' Yaudah Deh... Tante Diem😒"}'
        kalem = '{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":"waalaikumsalam😇"}'
        bangun = '{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":" ' + nick + '  Iya Sayang... Tante Nyapa Kok❤️  "}'
        bangun2 = '{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":"Apasih  ' + nick + ' panggil panggil MJ 😏 kek yang mau ngasih duit ajah 😝 "}'
        johnson = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"eeeeeeh siapa?🤔  ' + nick + ' - "Ku Kasih Tau Ya JHONSON Itu Emang Gada Otak " "}'
        ...
        fans = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"' + nick + ' pagi juga kaka semoga hari mu menyenangkan yah💞💞😚"}'
        promot = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":" heh! ' + nick + ' emang kita udah saling kenal?🙄"}'
        ig = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"Hai ' + nick + ' Malam Juga Kamu, Jangan bergadang kak !! 😊"}'
        makasih = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":"' + nick + ' iya sore lah😒 kata siapa malam🙄 dasar 🚮"}'
        jawab = '{"appversion":"5.4.9","event":"live_message","token":"","useragent":"Android","message":" aku kasih tau yah  ' + nick + ' bos aku itu 🙈🙈🙈🙈 ? kepo bet sih anda "}'
        rank = '{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":"  {control}  ' + nick + ' cek in -(RANK 1/30 SUKSES UPDATE)-"}'
        if evn == 'live_message' and (psn == '$status' or psn == '$durasi' or psn == '$info'):
        	...
        	ws.send('{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":" [info durasi ~ in room ] : 💖🖤 '+ str(timehl2) +' 🖤💖 "}')
        ...
        if evn == 'live_message' and psn[:-3] == '$rank':
            ...
            ws.send('{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":"Info rank ' + str(xz + 1) + '  nama: ' + nama + ' judul: ' + judul + '  durasi -> ' + str(timeh) + ' "}')
        ...
        if evn == 'live_message' and psn == '$me':
            ...
            ws.send('{"appversion":"5.4.9","event":"live_message","token":" ","useragent":"Android","message":"Info username ' + nn + ' tanggal akun dibuat -> ' + str(tangga) + ' GMT +0 "}')
